...
import { UploadButtonWidget, ImageCellWidget } from "./utils_widgets.js";

const forImageCount = (callback, count = 6) => {
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (nodeData.name === "ImageSwitchSelect") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                // Create file upload inputs and event listeners
                this.fileInputs = [];
                forImageCount((i) => {
                    ...
                    const button = this.addCustomWidget(new UploadButtonWidget(this, i, () => {
                        this.fileInputs[i].click();
                    }))
                    ...
                    fileInput.addEventListener("change", (event) => {
                        ...
                        if (file) {
                            ...
                            // If this is the selected cell (even if empty), update both widgets
                            if (index === this.selectedIndex) {
                                ...
                                if (indexWidget) {
                                    indexWidget.value = this.selectedIndex;
                                    indexWidget.callback?.(this.selectedIndex);
                                }
                            }
                        }
                    });
